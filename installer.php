...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200625_yolandalr_8035b1d0aff1d7b19427_20230103091128_archive.zip';
	const ARCHIVE_SIZE		 = '1080676';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8035b1d-03091128';
    const SECONDARY_PACKAGE_HASH = 'e3922b5-03091128';
